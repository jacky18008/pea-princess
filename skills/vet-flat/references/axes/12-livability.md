...
1. `python3 scripts/geo.py nearby "<postcode>" --radius 400` and `python3 scripts/roads.py near --lat <lat> --lng <lng> --radius 400 --brief` — the nearest food shop, launderette, pharmacy and the walking distance to each.
