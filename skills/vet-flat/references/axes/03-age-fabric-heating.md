...
5. Heat networks: `python3 scripts/redress.py heat-trust --site "<building>"`, then `python3 scripts/company.py search --name "<supplier>"` → `profile` → `filings` for the accounts and the registered office.
