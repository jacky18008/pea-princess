...
|---|---|---|
| "no ground floor" | `floors.reject_ground_floor: true` | L10 floor and numbering |
...
- **Does it decide for me?** No. It gives a verdict with the evidence behind it; you decide.
