...
def main(argv=None):
    ...
    # An asserted complete monthly cost with missing inputs is impossible to
    # validate. Treat it as an error even without --strict; ordinary rounding
    # and unrelated arithmetic warnings keep their existing opt-in strict gate.
