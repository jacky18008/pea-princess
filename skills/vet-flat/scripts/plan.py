...
CALLS = {
    1: {"lite": [('scripts/geo.py lookup "<postcode>"',
                 ...
                 ('scripts/epc.py search --postcode "<postcode>" --brief --match "<building>"',
    ...
    4: {"standard": [("scripts/planning.py near --lat <lat> --lng <lng> --radius 250 --brief",
        ...
        "deep": [("scripts/planning.py stages <application_reference>",
                 ...
                 ("scripts/roads.py near --lat <lat> --lng <lng> --brief",
    ...
    8: {"lite": [("scripts/calc.py price-per-sqft --rent-pcm <rent_pcm> --area-m2 <area_m2>",
        ...
        "standard": [],
        "deep": [('scripts/landregistry.py price-paid --postcode "<postcode>" --brief',
